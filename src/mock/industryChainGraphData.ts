 ...
 * @position Mock 数据层，由 parseChainXlsx.ts + buildChainStats.ts 脚本自动生成，勿手动编辑
 */
// Auto-generated by scripts/parseChainXlsx.ts + scripts/buildChainStats.ts — do not edit manually
